...
<head>
  ...
  <meta name="description" content="Fácil instalación, flexibles y resistentes a la interperie y el agua.">
  <meta name="robots" content="index"/>
  <meta property="og:title" content="Rollos de Polietileno - Inveralia | Servicios Agrícolas + Geomembranas">
  <meta property="og:image" content="https://parainvernaderos.mx/imagenes/productos/rollo-polietileno.jpg">
  <meta property="og:url" content="https://parainvernaderos.mx/">
  <meta property="og:description" content="Fácil instalación, flexibles y resistentes a la interperie y el agua.">
  <title>Rollos de Polietileno - Inveralia | Servicios Agrícolas + Geomembranas</title>
        ...
        <section class="product__container">
          <div class="product__image-container">
            <div class="product__image-main">
              <img id="template-img" src="https://parainvernaderos.mx/imagenes/productos/rollo-polietileno.jpg" alt="Rollos de polietileno">
            </div>
            <div class="prodcut__image-gallery">
              <img src="https://parainvernaderos.mx/imagenes/productos/rollo-polietileno.jpg" alt="Rollos de polietileno" class="product__image-gallery-article">
              <img src="https://parainvernaderos.mx/imagenes/productos/rollo-polietileno-1.jpg" alt="Rollos de polietileno" class="product__image-gallery-article">
              <img src="https://parainvernaderos.mx/imagenes/productos/rollo-polietileno-2.jpg" alt="Rollos de polietileno" class="product__image-gallery-article">
            </div>
          </div>
