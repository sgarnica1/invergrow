...
<head>
  ...
  <meta property="og:title" content="Spacer - Invergrow | Soluciones Agrícolas">
  ...
  <title>Spacer - Invergrow | Soluciones Agrícolas</title>
        ...
        <section class="product__container">
          <div class="product__image-container">
            <div class="product__image-main">
              <img id="template-img" src="https://parainvernaderos.mx/imagenes/productos/spacer-2-min.jpg" alt="Spacer">
            </div>
            <div class="prodcut__image-gallery">
              <img src="https://parainvernaderos.mx/imagenes/productos/spacer-2-min.jpg" alt="Spacer" class="product__image-gallery-article">
              <img src="https://parainvernaderos.mx/imagenes/productos/spacer-min.jpg" alt="Spacer" class="product__image-gallery-article">
            </div>
          </div>
          <div class="product__info">
            <h1 class="product__title">Spacer</h1>
            <div class="product__divider"></div>
            <div class="product__description">
              <p>
                El Spacer es un soporte elevador de bolsa de hidroponía fabricado de polipropileno que permite la ventilación por debajo de la bolsa que al estar levantada del suelo evita el desarrollo de la raíz fuera de la bolsa evitando enfermedades, además sus amplios huecos entre cada uno de los 16 hexágonos permite un excelente drenaje y también la colocación de canaletas de drenaje por debajo. Cada base puede soportar hasta 75 kilogramos y son de muy fácil instalación.
              </p>
            </div>
