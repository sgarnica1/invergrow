...
<head>
  ...
  <meta property="og:title" content="Rafia y ganchos para tutoreo - Inveralia | Servicios Agrícolas + Geomembranas">
  ...
  <title>Rafia y ganchos para tutoreo - Inveralia | Servicios Agrícolas + Geomembranas</title>
      ...
      <div class="wrapper" id="inicio">
        <section class="product__container">
          <div class="product__image-container">
            <div class="product__image-main">
              <img id="template-img" src="https://parainvernaderos.mx/imagenes/productos/rafia-para-tutoreo-2-min.jpg" alt="Rafia y ganchos para tutoreo">
            </div>
            <div class="prodcut__image-gallery">
              <img src="https://parainvernaderos.mx/imagenes/productos/rafia-para-tutoreo-2-min.jpg" alt="Rafia y ganchos para tutoreo" class="product__image-gallery-article">
              <img src="https://parainvernaderos.mx/imagenes/productos/rafia-para-tutoreo-min.jpg" alt="Rafia y ganchos para tutoreo" class="product__image-gallery-article">
            </div>
          </div>
          <div class="product__info">
            <h1 class="product__title">Rafia y ganchos para tutoreo</h1>
            <div class="product__divider"></div>
            <div class="product__description">
              <p>
                La rafia para tutoreo le ofrecerá un soporte a su cultivo para que las plantas puedan crecer y fortalecerse de forma adecuada. La rafia permite que su cultivo sea vertical, en lugar de extensivo, logrando un mejor aprovechamiento de la tierra. Esto no solo vuelve al campo más compacto, sino que también protege al cultivo de la exposición excesiva y permite un control más fácil. 
              </p><br>
              <p>   
                Otro beneficio de la rafia es que ayuda a mantener la planta a una distancia considerable del suelo, lo que se traduce en fruta más limpia y menos posibilidades de contaminación debido a un mal manejo del suelo, logrando hojas más sanas y libres de contaminantes. Tiene protección contra rayos UV, es muy suave al tacto y no daña su cultivo ni sus clips.
              </p>  
            </div>
        ...
        <section class="related-products__container">
          ...
          <div class="related-products__list">
            ...
            <a href="./mallas-antiafidos" class="related-products__item">
              <img src="https://parainvernaderos.mx/imagenes/productos/mallas-antiafidos-min.jpg" alt="Mallas antiáfidos ">
              <h4>Mallas antiáfidos </h4>
            </a>
          </div>
