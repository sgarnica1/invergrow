...
<head>
  ...
  <meta property="og:title" content="Charolas de propagación - Inveralia | Servicios Agrícolas + Geomembranas">
  ...
  <title>Charolas de propagación - Inveralia | Servicios Agrícolas + Geomembranas</title>
      ...
      <div class="wrapper" id="inicio">
        <section class="product__container">
          <div class="product__image-container">
            <div class="product__image-main">
              <img id="template-img" src="https://parainvernaderos.mx/imagenes/productos/charolas-de-propagacion-2-min.jpg" alt="Clip para tutoreo">
            </div>
            <div class="prodcut__image-gallery">
              <img src="https://parainvernaderos.mx/imagenes/productos/charolas-de-propagacion-2-min.jpg" alt="Charolas de propagación" class="product__image-gallery-article">
              <img src="https://parainvernaderos.mx/imagenes/productos/charolas-de-propagacion-min.jpg" alt="Charolas de propagación" class="product__image-gallery-article">
            </div>
          </div>
          <div class="product__info">
            <h1 class="product__title">Charolas de propagación</h1>
            <div class="product__divider"></div>
            <div class="product__description">
              <p>
                Nuestras charolas de germinación tienen excelentes cualidades para la siembra de una gran variedad de semillas, tiene el diseño y tamaño adecuado para lograr una rápida y saludable germinación. 
              </p><br>
              <p>   
                Las cavidades que pueden ser de acuerdo a la necesidad que usted requiera le dan a la semilla el espacio adecuado para el desarrollo de la plántula, permite la extracción del cepellón con facilidad, con limpieza y con raíces totalmente compactas y bien formadas.
                Tienen un diámetro exacto para el correcto drenaje sin que se pierda turba o humedad.
              </p>  
            </div>
        ...
        <section class="related-products__container">
          ...
          <div class="related-products__list">
            <a href="./spacer" class="related-products__item">
              <img src="https://parainvernaderos.mx/imagenes/productos/spacer-2-min.jpg" alt="Spacer">
              <h4>Spacer</h4>
            </a>
