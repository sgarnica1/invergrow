...
<head>
  ...
  <meta property="og:title" content="Geomembrana - Inveralia | Soluciones Agrícolas + Geomembranas">
  <meta property="og:image" content="https://parainvernaderos.mx/imagenes/productos/geomembrana-min.jpg">
  ...
  <title>Geomembrana - Inveralia | Soluciones Agrícolas + Geomembranas</title>
      ...
      <div class="wrapper" id="inicio">
        <section class="product__container">
          ...
          <div class="product__info">
            <h1 class="product__title">Geomembrana</h1>
            <div class="product__divider"></div>
            <div class="product__description">
              <p>
                Son productos fabricados en  (HDPE) o (PVC), su principal función es la impermeabilización de: lagos artificiales, rellenos sanitarios y tanques de combustibles.
              </p>  
              <p>
                Este producto se puede encontrar de diversos espesores.
                Las ventajas son las siguientes:
              </p>  
              <ul>
                <li>Son impermeables</li>
                <li>Alta resistencia a agentes químicos</li>
                <li>Flexible</li>
                <li>Fácil de reparar</li>
                <li>Con caras lisas o texturizada</li>
                <li>Puede ser de diferentes colores</li>
              </ul>
            </div>
